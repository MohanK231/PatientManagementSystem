...
//                createDatabase("AuthServiceDB", "auth-service-db");
        ...
        CfnHealthCheck authHealthCheck =
                createDbHealthCheck(patientServiceDb, "AuthServiceDBHealthCheck");
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4010),
                        patientServiceDb,
                        Map.of("JWT_SECRET","401c4c262bbaa96057d7aaf089378eb6cd4a2c8c10052354f3f040ff71c5f4d4"));
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        ...
                        .environment(Map.of(
                                ...
                                "AUTH_SERVICE_URL", "http://host.docker.internal:4010"
                        ))
